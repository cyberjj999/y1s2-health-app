...
public class HomeViewController1 {
	...
	// Event Listener on Button[#Physio].onMouseClicked
	@FXML
	public void goPhysio(ActionEvent event) throws IOException {
		
		FXMLLoader loader=new FXMLLoader();
		loader.setLocation((getClass().getResource("/healthApp/view/ConditionSelection.fxml")));
	...
	public void GoPrograms(ActionEvent event) throws IOException {
		...
		//healthApp programsView = new healthApp();
		//programsView.goPrograms();
	...
	// Event Listener on Button[#Programs].onAction
